    ...
    <>
      <div className="lg:hidden flex items-center gap-3 px-4 py-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {author.role && (
            <p className="text-[15px] text-muted-foreground mt-0.5">{author.role}</p>
          )}
        </div>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {open && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-card rounded shadow-xl border border-border py-1 z-50">
              {author.location && (
                <div className="flex items-center gap-2 px-3 py-2 text-card-foreground">
              ...
              {author.email && (
                <a
                  href={author.email}
                  className="flex items-center gap-2 px-3 py-2 text-card-foreground hover:bg-muted"
                >
      ...
      <div
        className={cn(
          "hidden lg:block bg-inherit text-foreground pt-2 px-6 pb-6 w-full max-w-[260px]",
          className
        )}
      >
        <div className="flex flex-col items-start">
          <div className="flex items-center justify-center mb-6 w-[135px] h-[135px] relative">
            <div
              aria-hidden
              className="absolute rounded-full w-full h-full border-[0.7px] border-border [box-shadow:0_0_0_1px_hsl(var(--border)),inset_0_0_20px_rgba(0,0,0,0.4)]"
            />
          ...
          {author.role && (
            <p className="text-[15px] text-foreground mb-5 pl-2">
              {author.role}
            </p>
          )}
